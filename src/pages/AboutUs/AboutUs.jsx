    ...
    <div className="flex flex-col mt-[64px] items-center font-roboto bg-white">
      ...
      <div className="m-10 max-w-[1024px]">
        ...
        <p className="mb-10 text-[72px]">
          Our mission is to recreate the YouTube frontend to the best of our
          ability while interacting with React.
        </p>
        <p className="mb-10 text-[72px] font-thin">
          This project does not include a backend and thus utilises the official
          YouTube API to fetch data directly from Youtube.
        </p>
        <p className="mb-10 text-[72px] font-thin">
